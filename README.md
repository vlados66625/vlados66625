...
<p align="left">В течение 7 месяцев на практике выполнение проектов производилось по критериям реальной компании - <a href="https://ligaa.agency/">Лига А.</a>. Работа велась в команде разработчиков, менеджера проекта, тестировщика, дизайнера. В проектах, в зависимости от ТЗ необходимо было:<br>- соблюдать критерии качества<br>- поддерживать различные версии браузеров и ОС<br>- создавать интерактивные блоки (табы, слайдеры, попапы и т.д.)<br>- выполнять правки по замечаниям тестировщика</p>
